...
set.seed(123)
kmeans_res <- kmeans(DataExpMoy[,-c(19,20,21)], centers = 6, nstart = 25)
fviz_cluster(kmeans_res, data = DataExpMoy[,-c(19,20,21)])
table(DataExpMoy$ExpT1,kmeans_res$cluster)

kmeans_res <- kmeans(DataExpMoy[,-c(19,20,21)], centers = 4, nstart = 25)
fviz_cluster(kmeans_res, data = DataExpMoy[,-c(19,20,21)])
